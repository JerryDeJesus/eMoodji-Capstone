...
export default function StepForm() {
    ...
    switch (currentStep) {
        ...
        default: return <Step4 progressBarComponent = {<Progress type="circle" strokeWidth={6} width={200} percent={100} status="active" style={{fontSize: '100px'}} theme={{active: {symbol:'😁', color: '#32C20E'}}}/>} entry = {entry} back = {back} activitiesData = {activitiesData} />;
    }
}