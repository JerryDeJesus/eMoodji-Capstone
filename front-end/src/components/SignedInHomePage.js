    ...
    return(
            ...
            <div className="sIHomePage">
                ...
                <div className='eBGrid'>
                    ...
                    <Link id='nEntry' to="/wizard"><button style={{'width': '200px', 'height': '50px', 'border-radius': '10px', 'background-color': 'rgb(153, 186, 221)', 'color': 'white', 'font-weight': '700', 'font-size': '25px', 'outline': 'none'}}> New Entry </button></Link>
                    <Link id='aEntry'  to={userEntriesLink}><button style={{'width': '200px', 'height': '50px', 'border-radius': '10px', 'background-color': 'rgb(153, 186, 221)', 'color': 'white', 'font-weight': '700', 'font-size': '25px', 'outline': 'none'}} >All Entries</button></Link>
                    </div>
                </div>
            </div>
